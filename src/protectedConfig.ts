...
const ALLOWED=new Set(["BROKER_PROJECT_KEY","BROKER_REPO_ROOT","BROKER_WORKTREE_ROOT","BROKER_EXPECTED_REMOTE_URL","BROKER_GITHUB_REPO","BROKER_GIT_REMOTE","BROKER_BASE_REF","BROKER_BASE_BRANCH","BROKER_PROFILES","BROKER_STATE_ROOT","BROKER_AGENT_KIND"]);
